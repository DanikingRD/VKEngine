...
void vulkan_command_buffer_allocate(
    VulkanBackend* backend, VkCommandPool pool, bool is_primary, CommandBuffer* out_command_buffer
);
...
void vulkan_command_buffer_allocate_and_begin_single_use(
    VulkanBackend* backend, VkCommandPool pool, CommandBuffer* out_command_buffer
);
